...
- [PASS] AC1: `content/projects/lab/README.md` exists with sanitized inventory structure and no internal identifiers.
- [PASS] AC2: Explicit redaction rules exist in `PROOF_PACK/REDACTION_RULES.md` and are referenced from `content/projects/lab/README.md`.
